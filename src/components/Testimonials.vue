        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div
                ...
                <div class="flex flex-col sm:flex-row lg:items-center">
                    <img class="object-cover w-48 h-48 mx-auto sm:mx-0 lg:w-60 lg:h-60 shrink-0 rounded-2xl"
                    ...
                    <div class="mt-8 sm:mt-0 sm:ml-10">
                        ...
                        <blockquote class="mt-8">
                            <p class="text-lg font-medium leading-8 text-gray-900">"AceStyle Editing helped me refine my dissertation, ensuring error-free and polished content."</p>
                        </blockquote>
                        <div
                ...
                <div class="flex flex-col sm:flex-row lg:items-center">
                    ...
                    <div class="mt-8 sm:mt-0 sm:ml-10">
                        ...
                        <blockquote class="mt-8">
                            <p class="text-lg font-medium leading-8 text-gray-900">"I was impressed by the prompt service and meticulous editing"</p>
                        </blockquote>
                        <div
                            class="flex flex-col flex-wrap items-center justify-center gap-1 mt-5 sm:flex-row sm:justify-start sm:gap-4">
