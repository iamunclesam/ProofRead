<template>
      ...
      <section class="py-10 bg-gray-50 sm:py-16 lg:py-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="max-w-2xl mx-auto text-center">
            <h2 class="mb-4 text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-4xl">Login</h2>
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      <div class="flex items-center justify-between">
                        ...
                        <router-link to="/forgot-password" title="" class="text-sm font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 focus:text-orange-600 hover:underline"> Forgot password? </router-link>
                      </div>
                      <div class="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                          <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="text-center">
                      <p class="text-base text-gray-600">Don’t have an account? <router-link to="/signup" class="font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline">Create a free account</router-link></p>
                    </div>
                  </div>
                </form>
              </div>
  ...
  <script>
  import { signInWithEmailAndPassword, auth } from "@/firebase"; // Import Firebase authentication method
    ...
    methods: {
      async handleSignIn() {
        ...
        try {
          ...
          this.$router.push("/upload"); // Redirect after successful sign-in
        } catch (error) {
